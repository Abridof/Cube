...
class SymbolicParser:
    ...
    def parse(self, content: Any, content_type: str, source: Optional[str] = None) -> List[SymbolicNode]:
        """通用解析接口"""
...
"""
    unit = engine.create_unit(code, content_type='code', domain='programming', tags={'python', 'arithmetic'})
    ...
    """
    unit = engine.create_unit(text, content_type='text', domain='physics', tags={'thermodynamics', 'phase_change'})
    print(f"Created unit: {unit.id}")
