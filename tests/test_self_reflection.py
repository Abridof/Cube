...
class TestSystemOrchestrator(unittest.TestCase):
    ...
    def test_module_info(self):
        ...
        info = ModuleInfo(name="test_module", class_name="TestClass", module_path="test_module")
    ...
    def test_event_creation(self):
        ...
        event = Event(
            event_type="test.event", source="test", data={"key": "value"}, priority=Priority.HIGH
        )
    ...
    def test_event_bus(self):
        ...
        event = Event(event_type="test.event", source="test", data={}, priority=Priority.NORMAL)
        bus.publish(event)
    ...
    def test_module_registration(self):
        ...
        new_module = ModuleInfo(
            name="custom_module", class_name="CustomClass", module_path="custom_module"
        )
