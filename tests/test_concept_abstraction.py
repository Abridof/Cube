...
class TestMetaPatternRecognizer:
    ...
    def sample_cases(self, recognizer):
        ...
        org_case = create_case(
            ...
            relationships=[("CEO", "manages", "manager"), ("manager", "manages", "employee")],
        )
    ...
    def test_identify_hierarchical_pattern(self, recognizer):
        ...
        case = create_case(
            ...
            relationships=[("animal", "contains", "mammal"), ("mammal", "contains", "dog")],
        )
    ...
    def test_identify_causal_pattern(self, recognizer):
        ...
        case = create_case(
            ...
            relationships=[("domino1", "causes", "domino2"), ("domino2", "causes", "domino3")],
        )
        recognizer.add_case(case)
    ...
    def test_find_isomorphism(self, sample_cases):
        ...
        isomorphism = sample_cases.find_isomorphism("biology_food_chain", "physics_energy_transfer")
    ...
    def test_discover_cross_domain_patterns(self, sample_cases):
        ...
        if len(patterns) > 0:
            # 应该发现生物学和物理学之间的相似模式
            cross_domain_found = any(p["domain1"] != p["domain2"] for p in patterns)
    ...
    def test_no_isomorphism_for_dissimilar_cases(self, recognizer):
        ...
        isolated_case = create_case(
            domain="isolated", name="single", entities=["X"], relationships=[]
        )
...
class TestEdgeCases:
    ...
    def test_empty_case(self, recognizer):
        """测试空案例"""
        case = create_case(domain="empty", name="void", entities=[], relationships=[])
        recognizer.add_case(case)
    ...
    def test_single_entity_case(self, recognizer):
        """测试单实体案例"""
        case = create_case(
            domain="singleton", name="alone", entities=["only_one"], relationships=[]
        )
        recognizer.add_case(case)
    ...
    def test_full_workflow(self):
        ...
        cases = [
            ...
            create_case(
                ...
                [("leader", "influences", "follower"), ("follower", "influences", "observer")],
            ),
        ]
        ...
        # 查询相似结构
        query = create_case(
            "query", "test", ["A", "B", "C"], [("A", "affects", "B"), ("B", "affects", "C")]
        )
    ...
    def test_pattern_recognition_accuracy(self):
        ...
        test_cases = [
            ...
            (
                ...
                [("A", "leads_to", "B"), ("B", "leads_to", "C"), ("C", "leads_to", "A")],
            ),
            (
                PatternType.CAUSAL,
                [("cause", "causes", "effect1"), ("effect1", "causes", "effect2")],
            ),
        ]
        ...
        for expected_type, relations in test_cases:
            ...
            # 验证识别的模式类型正确
            assert (
                structure.pattern_type == expected_type
