...
class TestIntrinsicMotivationEngine(unittest.TestCase):
    ...
    def test_process_prediction_reward(self):
        ...
        reward = self.engine.process_prediction(
            predicted=5.0,
            actual=7.0,
            var_name="test_var"
        )
