...
class TestLearningStrategy(unittest.TestCase):
    ...
    def test_creation_and_success_rate(self):
        ...
        strategy = LearningStrategy(
            id="test_strat", name="Test Strategy", description="A test strategy", domain="general"
        )
...
class TestHypothesis(unittest.TestCase):
    ...
    def test_creation_and_update(self):
        """测试创建和更新"""
        hyp = Hypothesis(id="hyp1", description="Test hypothesis")
...
class TestKnowledgeGraph(unittest.TestCase):
    ...
    def test_add_edge(self):
        ...
        edge = self.graph.add_edge(
            node_ids[0], node_ids[1], RelationType.CAUSES, weight=0.8, evidence=["test evidence"]
        )
...
class TestHybridRetriever(unittest.TestCase):
    ...
    def test_retrieve_graph_only(self):
        """测试仅图谱检索"""
        results = self.retriever.retrieve("learning", top_k=5, use_vector=False, use_graph=True)
    ...
    def test_retrieve_vector_only(self):
        ...
        results = self.retriever.retrieve(
            "neural networks", top_k=5, use_graph=False, use_vector=True
        )
...
class TestMetaLearner(unittest.TestCase):
    ...
    def test_select_strategy(self):
        """测试策略选择"""
        strategy = self.learner.select_strategy("Test problem", domain="general")
    ...
    def test_generate_hypothesis(self):
        ...
        hyp = self.learner.generate_hypothesis(
            "Observation about learning", ["concept1", "concept2"]
        )
...
class TestEnhancedMemoryBank(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.memory = EnhancedMemoryBank(
            storage_path="test_memory.json", graph_storage_path="test_knowledge_graph.json"
        )
    ...
    def test_add_knowledge(self):
        ...
        unit = self.memory.add_knowledge(
            "Test knowledge content", content_type="text", domain="test", tags={"test_tag"}
        )
    ...
    def test_retrieve_knowledge(self):
        ...
        self.memory.add_knowledge(
            "Python programming language features", domain="programming", tags={"python"}
        )
